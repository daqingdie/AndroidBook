...
<a href="Admin.do?action=seeUser">返回查看用户</a><br><br>
<form method="post" action="<%=path%>/User.do?action=updateUser&id=${changeUser.userId}">
						...
						<td width="81%" background="image/index_right_bg.gif">
							<form name="form1" method="post" action="register_confirm.jsp">
								...
								<tr align="center" bgcolor="#FFFFFF">
									...
									<td>
									<div align="center">
										<input type="text" name="userid" value="${changeUser.userId} " disabled>
										</div>
									</td>
								</tr>
								<tr align="center" bgcolor="#FFFFFF">
								...
								<tr align="center" bgcolor="#FFFFFF">
									...
									<td>
									<div align="center">
										<input type="text" name="userpassword" value="${changeUser.userPassword }" disabled>
										</div>
									</td>
								</tr>
								<tr bgcolor="#FFFFFF">
