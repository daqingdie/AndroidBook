...
<form method="post" action="<%=path%>/Book.do?action=add"> 
						...
						<td width="81%" background="image/index_right_bg.gif">
							<form name="form1" method="post" action="register_confirm.jsp">
								...
								<tr bgcolor="#FFFFFF">
									...
									<td height="25">
										<div align="center">
											<input type="text" name="bookConcern" value="">
										</div>
									</td>
								</tr>
								<tr bgcolor="#FFFFFF">
									...
									<td height="25">
										<div align="center">
											<input type="text" name="bookNumber" value="">
										</div>
									</td>
								</tr>
								<tr bgcolor="#FFFFFF">
...
<tr bgcolor="#FFFFFF">
									...
									<td height="25">
										<div align="center">
											<input type="text" name="bookSummary" value="">
										</div>
									</td>
								</tr>
								<tr align="center" bgcolor="#FFFFFF">
									<td colspan="2">
										<input type="submit" value="确定添加" width="50" height="22" border="0">
									</td>
								</tr>
								</table>
								<span class="top">
